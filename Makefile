...
SOURCES += models/transform.cpp models/cube.cpp models/drawableObject.cpp models/sphereMesh.cpp models/cubeMesh.cpp models/sphere.cpp models/meshLoader.cpp models/meshObject.cpp models/mesh.cpp

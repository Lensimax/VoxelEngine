...
void MeshIndexed::createMeshFromFile(std::string filename){
  ...
  m_maxX = m_maxY = m_maxZ = -std::numeric_limits<float>::max();
    ...
    for (size_t f = 0; f < shapes[0].mesh.indices.size() / 3; f++) {
        ...
        int current_material_id = shapes[0].mesh.material_ids[f];
        ...
        m_coords.push_back(glm::vec2(tc[0][0], tc[0][1]));
        m_coords.push_back(glm::vec2(tc[1][0], tc[1][1]));
        m_coords.push_back(glm::vec2(tc[2][0], tc[2][1]));
        ...
        m_vertices.push_back(glm::vec3(v[0][0], v[0][1], v[0][2]));
        m_vertices.push_back(glm::vec3(v[1][0], v[1][1], v[1][2]));
        m_vertices.push_back(glm::vec3(v[2][0], v[2][1], v[2][2]));
        ...
        m_colors.push_back(glm::vec3(n[0][0], n[0][1], n[0][2]));
        m_colors.push_back(glm::vec3(n[1][0], n[1][1], n[1][2]));
        m_colors.push_back(glm::vec3(n[2][0], n[2][1], n[2][2]));
